                      ...
                      <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
                        <div>
                          ...
                          <p className="mt-1 text-sm font-semibold text-slate-700">
                            Sharing {resort.sharingPrice ? formatPerPersonPrice(resort.sharingPrice) : "not set"} - Couple {resort.couplePrice ? formatPerPersonPrice(resort.couplePrice) : "not set"}
                          </p>
